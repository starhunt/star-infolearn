...
노트를 AI 기반 퀴즈, 빈칸 카드, 복습 워크플로가 포함된 인터랙티브 학습 카드로 바꾸는 플러그인입니다.

## 주요 기능

- 노트 내용을 기반으로 AI 학습 카드 생성
- 플래시카드, 객관식, 빈칸 채우기, 단답형 지원
- FSRS 스타일 간격 반복 복습 워크플로
- 현재 노트, 폴더, 기간별 복습 필터
- 로컬 학습 대시보드로 진행 상황 확인
...
1. 설정 → 커뮤니티 플러그인을 엽니다.
2. **Star InfoLearn**를 검색합니다.
3. 설치 후 활성화합니다.

### 수동 설치

1. 최신 [GitHub 릴리스](https://github.com/starhunt/star-infolearn/releases/latest)에서 `main.js`, `manifest.json`, `styles.css`를 다운로드합니다.
2. `<vault>/.obsidian/plugins/star-infolearn/` 폴더를 만듭니다.
3. 다운로드한 파일을 해당 폴더에 복사합니다.
4. 앱을 다시 시작하거나 플러그인을 새로고침한 뒤 **Star InfoLearn**를 활성화합니다.
...
1. 커뮤니티 플러그인에서 **Star InfoLearn**를 활성화합니다.
